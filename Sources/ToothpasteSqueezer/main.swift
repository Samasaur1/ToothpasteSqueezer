...
let slopingHole = OpenSCAD.hexahedron(bottom: (OpenSCAD.Point(32.5, 3.5, -15), OpenSCAD.Point(32.5, -3.5, -15), OpenSCAD.Point(-32.5, -3.5, -15), OpenSCAD.Point(-32.5, 3.5, -15)), top: (OpenSCAD.Point(30, 1, -5), OpenSCAD.Point(30, -1, -5), OpenSCAD.Point(-30, -1, -5), OpenSCAD.Point(-30, 1, -5)))


let grippingHole = OpenSCAD.cylinder(height: 15, topRadius: 10, bottomRadius: 10, centered: true).rotated(by: 90, 0, 0).translated(by: 0, 0, 10).resized(to: 20, 15, 31)
